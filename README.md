...
|---|---|---|
| ![Upload page](backend/assets/screenshots/upload.png) | ![Analysis page](backend/assets/screenshots/analysis.png) | ![Dashboard](backend/assets/screenshots/dashboard.png) |
